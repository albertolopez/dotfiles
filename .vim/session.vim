...
inoremap <silent> <Plug>delimitMate{ {=delimitMate#ParenDelim("}")
inoremap <silent> <Plug>delimitMate( (=delimitMate#ParenDelim(")")
inoremap <silent> <SNR>15_yrrecord =YRRecord3()
imap <C-Tab> :tabnexti
...
nmap \d :bw
nmap \q :tabnew ~/postgre.sql
nmap \gsd :Git svn dcommit
nmap \gsr :Git svn rebase
nmap \gst :Gstatus
nmap \f :Ack! 
...
nnoremap <silent> <SNR>15_yrrecord :call YRRecord3()
...
nnoremap <F9> :GundoToggle
map <F7> :NERDTreeToggle
nmap <F8> :TagbarToggle
nnoremap <silent> <F10> :YRShow 
vmap <C-Down> xp`[V`]
vmap <C-Up> xkPz[V`]
nmap <C-Down> ddp
nmap <C-Up> ddkP
...
setlocal tabstop=4
setlocal tags=~/.dotfiles/.git/vim.tags,~/.dotfiles/.git/tags,./tags,./TAGS,tags,TAGS,~/.vimtags
...
silent! normal! zE
let s:l = 249 - ((6 * winheight(0) + 13) / 26)
